...
Collaborative document editing service for CollabSpace.

**Stack:** Node.js 24 · TypeScript · Fastify 5 · MongoDB Atlas (Stage 2+)
...
pnpm dev               # ts-node, serves on PORT (default 3000)
```
...
docker run -p 3000:3000 document-service
```
