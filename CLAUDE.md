...
- Feature workflow: docs/07-development/feature-workflow.md (per-feature procedure: three tiers, 8 phases, branching, feature-level DoD)
- Testing strategy: docs/07-development/testing-strategy.md (test types, per-language toolkits, Testcontainers lifecycle, injectable Clock pattern)
- GitHub PR template: .github/pull_request_template.md (auto-populates PR body per feature-workflow.md conventions)
